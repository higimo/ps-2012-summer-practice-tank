<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td id="battleType{$i.game_id}"> {$i.type}   </td>
      <td> <a href="#" id="{$i.game_id}" class="enterInGame{if {$i.user_count+$i.bot_count} >= 8}Disabled{/if}">Играть</a> | <a href="#" onclick="document.getElementById('lookForm{$i.game_id}').submit(); return false;">Смотреть</a>
